...
**Measured 2026-08-31/09-01 across every scheduled run in the repo's history — eight
runs, eight late.** Range **1h58m–6h24m**, and at least one slot skipped entirely.
Not one has fired within an hour of its nominal time.
...
| 34 | 10:21 | 04:00 | 6h21 |
| 35 | 18:08 | 11:45 | 6h24 |
| 36 | 09-01 00:58 | 22:00 (or 23:00) | 2h58 (or 1h58) |

🚩 **Run 36 is NOT evidence the mitigation worked, and must not be cited as such.** It
fired at 00:58 UTC on 09-01; the odd-minute crons only went live at 01:08 UTC with
`cf9c32e`. Run 36 was still on the `:00` schedule. Its much smaller lag is queue
variance, and it is the single strongest reason to be suspicious of the whole
odd-minute theory — the spread was already 3h43m–6h24m before anything changed, so
one good run proves nothing either way. **The first run under `:07/:17/:27` is 13:07
UTC on 09-01.** Judge the change on several days of runs, not on the next one.

Note also that only one of the `22:00`/`23:00` DST pair fired that evening. Collapsing
or dropping a slot is normal for this queue and is why the pair exists in the first place.
